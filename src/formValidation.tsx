...
> = function ({ errors, helperText, children, ...formGroupProps }) {
  const effectiveHelperText: JSX.Element | undefined =
...
const FieldErrors: React.FC<{ errors: ValidationError[]; className?: string }> =
