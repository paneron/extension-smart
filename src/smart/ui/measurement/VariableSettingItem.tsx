...
import { MMELVariable, MMELView, VarType } from '../../serialize/interface/supportinterface';
    ...
    }>
      {
        variable.type === VarType.BOOLEAN ? (            
          <Switch              
            ...
            onChange={profile !== undefined && profile.profile[variable.id] !== undefined && profile.profile[variable.id].isConst
              ? undefined
