...
export const endShape = (color:string) => (    
  <svg height="40" width="40">                      
    <circle cx="20" cy="20" r="15" stroke="black" strokeWidth="5" fill={color} />
  </svg>
)
...
export const timerShape = (color:string) => (  
  <svg height="40" width="40">                      
    <circle cx="20" cy="20" r="18" stroke="black" strokeWidth="2" fill={color} />
    <circle cx="20" cy="20" r="14" stroke="black" strokeWidth="2" fill={color} />
...
export const egateShape = (color:string) => (
  <svg height="40" width="40">
    <polygon points="0,20 20,0 40,20, 20,40" fill={color} stroke="black" strokeWidth="2" />    
  </svg>  
)
