...
const EnumEditPage: React.FC<{ modelWrapper: ModelWrapper, isVisible: boolean }> = ({ modelWrapper, isVisible }) => {
  ...
  let handle = new EnumHandler(modelWrapper, en, setAddMode, setUpdateMode, setUpdateEnum, forceUpdate, data, setData)
