...
const RoleEditPage: React.FC<{ model: Model, isVisible: boolean }> = ({ model, isVisible }) => {
  ...
  let handle = new RoleHandler(model, role, setAddMode, setUpdateMode, setUpdateRole, forceUpdate, data, setData)
