...
export class ProvisionHandler implements IList, IAddItem, IUpdateItem {
  ...
  constructor(model:Model, process: IProcess, oldValue:IProvision|null, setAdd:(b:boolean)=>void, setUpdate:(b:boolean)=>void, setOldValue:(x:IProvision)=>void, forceUpdate:()=>void, data:IProvision, setAttribute:(x:IProvision)=>void) {
    this.model = model
  ...
  getItems = ():Array<ProvisionListItem> =>  {
    let out:Array<ProvisionListItem> = []
