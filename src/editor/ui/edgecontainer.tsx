...
export class EdgeContainer {
  ...
  constructor(e:Edge) {    
    this.id = e.id
    if (e.from != null && e.from.element != null) { this.source = e.from.element.id }
    if (e.to != null && e.to.element != null) { this.target = e.to.element.id }
    if (e.description != "") { this.label = conditionExtract(e.description) }
