...
const MapperControlPane: React.FC<{sm:ModelViewStateMan, elms:Map<string, MappingProfile>}> = ({sm, elms}) => {
  ...
  const modelFileSelected = (e:ChangeEvent<HTMLInputElement>, readModel:(x:string) => void) => {    
