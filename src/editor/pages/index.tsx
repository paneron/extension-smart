...
const Home: React.FC<Record<never, never>> = function () {
  ...
  return (    
    <Wrapper>
      <div className="tab">
          <button onClick={() => setPage(Page.Editor)} style={page == Page.Editor?selected:normal}> Editor </button>
          <button onClick={() => setPage(Page.Mapper)} style={page == Page.Mapper?selected:normal}> Mapper </button>
      </div>
      <hr />
      <Main>
